  ...
  const handleRegister = async (role) => {
    ...
    try {
      if (role === "worker") {
        ...
        setMessage("Richiesta inviata. La tua azienda è in attesa di approvazione.");
      }
      setUsername("");
    } catch (err) {
    ...
    <div className="min-h-screen bg-secondary">
      ...
      <div className="container mx-auto py-12">
        ...
        <div className="max-w-md mx-auto bg-white p-6 rounded-xl shadow-lg">
          <label className="block text-lg font-semibold mb-2 text-center">Scegli uno username</label>
          <input
            type="text"
            value={username}
          ...
          <div className="flex justify-between space-x-4">
            <button
              ...
              disabled={!username}
              className={`flex-1 px-4 py-2 rounded text-white ${username
        ...
        <div className="mt-10 flex justify-center space-x-4">
          <a href="/worker" className="bg-primary text-white px-6 py-2 rounded hover:bg-blue-700">
            Lavoratore
          </a>
          <a href="/certifier" className="bg-primary text-white px-6 py-2 rounded hover:bg-blue-700">
            Certificatore
          </a>
          <a href="/verifier" className="bg-primary text-white px-6 py-2 rounded hover:bg-blue-700">
            Verificatore
          </a>
        </div>
      </div>
